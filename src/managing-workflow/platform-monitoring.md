...
* Enable persistence
* Use a supported external database such as mysql or postgres. You can find more information [here](https://github.com/deiscc/monitor/blob/master/grafana/rootfs/usr/share/grafana/grafana.ini.tpl#L62)
...
It is possible to send these metrics to other endpoints besides InfluxDB. For more information please consult the following [file](https://github.com/deiscc/monitor/blob/master/telegraf/rootfs/config.toml.tpl)
